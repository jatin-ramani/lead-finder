  ...
  return {
    ...
    components: {
      ...
      Select: {
        ...
        optionSelectedBg: dark ? "rgba(37,99,235,.18)" : p.subtle,
      ...
      Dropdown: { colorBgElevated: p.elevated, colorText: p.text },
      Popover: { colorBgElevated: p.elevated, colorText: p.text },
