...
function filtersOf(query: BusinessQuery) {
  const { search, city, category, has_website, has_email, has_phone, is_favorite, lead_grade, min_lead_score, max_lead_score, tags } = query;
  return { search, city, category, has_website, has_email, has_phone, is_favorite, lead_grade, min_lead_score, max_lead_score, tags };
}
